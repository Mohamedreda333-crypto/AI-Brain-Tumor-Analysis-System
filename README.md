...
-  **Classification** → Identify tumor type using EfficientNet  
-  **Detection** → Localize tumor regions using YOLOv8  
-  **Segmentation** → Extract precise tumor boundaries using U-Net  

Additionally, a **Streamlit web application** is provided for real-time interaction.
